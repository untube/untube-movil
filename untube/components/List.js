...
const show_first = [
    {
        key:'1',
        name: 'imagen1',
        image: 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/chilling-adventures-sabrina-1554819332.jpg'
    },

    {
        key: '2',
        name: 'imagen2',
        image: 'https://ksassets.timeincuk.net/wp/uploads/sites/55/2018/12/bm-920x584.png'
    },

    {
        key: '3',
        name: 'imagen3',
        image: 'https://estaticos.elperiodico.com/resources/jpg/0/6/zentauroepp44241260-television-serie-netflix-orange-the-new-black181019113824-1539942088360.jpg'
    },

    {
        key: '4',
        name: 'imagen4',
        image: 'https://vanguardia.com.mx/sites/default/files/game-of-thrones-season-6_yuwd.jpg'
    },
]
...
export default class List extends Component {
    _renderItem(item){
        return (
            ...
            <Image style={{height: 180, paddingBottom: 5, borderBottomWidth:5}} source={{uri: item.image}}></Image>
        )
    }
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                {/* <View style={styles.container}>
                    <Text style={styles.text}>Añadido reciente.</Text>
                    <FlatList 
                            // horizontal
