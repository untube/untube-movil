...
const show_second = [
    ...
    },
    {
        key: '5',
        name: 'Doctor House',
        description: "Un doctor con grandes habilidades pero con un extremo problema de actitud se enfrentara a los casos medicos mas extraños con sus metodos poco ortodoxos.",
...

    {
        key: '9',
		name: "Grey's anatomy",
		description: 'Grupo de doctores que tienen relaciones entre si y salvan muchas vidas mientras intentan solucionar las cosas de su vida, Grupo de doctores que tienen relaciones entre si y salvan muchas vidas mientras intentan solucionar las cosas de su vida.',
